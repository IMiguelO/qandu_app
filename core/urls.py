...
urlpatterns = patterns ('',
    ...
    url(r'^question/(?P<pk>\d+)/$', login_required(QuestionUpdateView.as_view()), name='question_update'),
    url(r'^question/(?P<pk>\d+)/$', login_required(QuestionDeleteView.as_view()), name='question_delete'),
